...
public class MultiplayerManager : MonoBehaviour
{
    ...
    private void DisplayQuestion(QuestionData questionData)
    {
        ...
        //richtige Antwort ausw�hlen und dann die ausgew�hlte Antwort als String senden
    ...
    public class GameState
    {
        ...
        public Dictionary<string, int> scores; // Aktuell hat jeder Spieler nur eine Spielfigur wird noch ge�ndert!!!
    }
    ...
    public class Player
    {
        public string uuid;
        public string name;
        public int playerPosition; // ob erster zweiter, dritter oder vierter spieler -> wichtig f�r den GameMaster
    }
}